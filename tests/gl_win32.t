...
def glAccum func(op GLenum; value GLfloat) extern_binding_dll("opengl32.dll");

def glAlphaFunc func(func GLenum; ref GLclampf) extern_binding_dll("opengl32.dll");

def glAreTexturesResident func(n GLsizei; textures GLuint ref; residences GLboolean ref) (result GLboolean) extern_binding_dll("opengl32.dll");

def glArrayElement func(i GLint) extern_binding_dll("opengl32.dll");

def glBegin func(mode GLenum) extern_binding_dll("opengl32.dll");

def glBindTexture func(target GLenum; texture GLuint) extern_binding_dll("opengl32.dll");

def glBitmap func(width GLsizei; height GLsizei; xorig GLfloat; yorig GLfloat; xmove GLfloat; ymove GLfloat; bitmap GLubyte ref) extern_binding_dll("opengl32.dll");

def glBlendFunc func(sfactor GLenum; dfactor GLenum) extern_binding_dll("opengl32.dll");

def glCallList func(list GLuint) extern_binding_dll("opengl32.dll");

def glCallLists func(n GLsizei; type GLenum; lists GLvoid ref) extern_binding_dll("opengl32.dll");

def glClear func(mask GLbitfield) extern_binding_dll("opengl32.dll");

def glClearAccum func(red GLfloat; green GLfloat; blue GLfloat; alpha GLfloat) extern_binding_dll("opengl32.dll");

def glClearColor func(red GLclampf; green GLclampf; blue GLclampf; alpha GLclampf) extern_binding_dll("opengl32.dll");

def glClearDepth func(depth GLclampd) extern_binding_dll("opengl32.dll");

def glClearIndex func(c GLfloat) extern_binding_dll("opengl32.dll");

def glClearStencil func(s GLint) extern_binding_dll("opengl32.dll");

def glClipPlane func(plane GLenum; equation GLdouble ref) extern_binding_dll("opengl32.dll");

def glColor3b func(red GLbyte; green GLbyte; blue GLbyte) extern_binding_dll("opengl32.dll");

def glColor3bv func(v GLbyte ref) extern_binding_dll("opengl32.dll");

def glColor3d func(red GLdouble; green GLdouble; blue GLdouble) extern_binding_dll("opengl32.dll");

def glColor3dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glColor3f func(red GLfloat; green GLfloat; blue GLfloat) extern_binding_dll("opengl32.dll");

def glColor3fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glColor3i func(red GLint; green GLint; blue GLint) extern_binding_dll("opengl32.dll");

def glColor3iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glColor3s func(red GLshort; green GLshort; blue GLshort) extern_binding_dll("opengl32.dll");

def glColor3sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glColor3ub func(red GLubyte; green GLubyte; blue GLubyte) extern_binding_dll("opengl32.dll");

def glColor3ubv func(v GLubyte ref) extern_binding_dll("opengl32.dll");

def glColor3ui func(red GLuint; green GLuint; blue GLuint) extern_binding_dll("opengl32.dll");

def glColor3uiv func(v GLuint ref) extern_binding_dll("opengl32.dll");

def glColor3us func(red GLushort; green GLushort; blue GLushort) extern_binding_dll("opengl32.dll");

def glColor3usv func(v GLushort ref) extern_binding_dll("opengl32.dll");

def glColor4b func(red GLbyte; green GLbyte; blue GLbyte; alpha GLbyte) extern_binding_dll("opengl32.dll");

def glColor4bv func(v GLbyte ref) extern_binding_dll("opengl32.dll");

def glColor4d func(red GLdouble; green GLdouble; blue GLdouble; alpha GLdouble) extern_binding_dll("opengl32.dll");

def glColor4dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glColor4f func(red GLfloat; green GLfloat; blue GLfloat; alpha GLfloat) extern_binding_dll("opengl32.dll");

def glColor4fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glColor4i func(red GLint; green GLint; blue GLint; alpha GLint) extern_binding_dll("opengl32.dll");

def glColor4iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glColor4s func(red GLshort; green GLshort; blue GLshort; alpha GLshort) extern_binding_dll("opengl32.dll");

def glColor4sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glColor4ub func(red GLubyte; green GLubyte; blue GLubyte; alpha GLubyte) extern_binding_dll("opengl32.dll");

def glColor4ubv func(v GLubyte ref) extern_binding_dll("opengl32.dll");

def glColor4ui func(red GLuint; green GLuint; blue GLuint; alpha GLuint) extern_binding_dll("opengl32.dll");

def glColor4uiv func(v GLuint ref) extern_binding_dll("opengl32.dll");

def glColor4us func(red GLushort; green GLushort; blue GLushort; alpha GLushort) extern_binding_dll("opengl32.dll");

def glColor4usv func(v GLushort ref) extern_binding_dll("opengl32.dll");

def glColorMask func(red GLboolean; green GLboolean; blue GLboolean; alpha GLboolean) extern_binding_dll("opengl32.dll");

def glColorMaterial func(face GLenum; mode GLenum) extern_binding_dll("opengl32.dll");

def glColorPointer func(size GLint; type GLenum; stride GLsizei; pointer GLvoid ref) extern_binding_dll("opengl32.dll");

def glCopyPixels func(x GLint; y GLint; width GLsizei; height GLsizei; type GLenum) extern_binding_dll("opengl32.dll");

def glCopyTexImage1D func(target GLenum; level GLint; internalFormat GLenum; x GLint; y GLint; width GLsizei; border GLint) extern_binding_dll("opengl32.dll");

def glCopyTexImage2D func(target GLenum; level GLint; internalFormat GLenum; x GLint; y GLint; width GLsizei; height GLsizei; border GLint) extern_binding_dll("opengl32.dll");

def glCopyTexSubImage1D func(target GLenum; level GLint; xoffset GLint; x GLint; y GLint; width GLsizei) extern_binding_dll("opengl32.dll");

def glCopyTexSubImage2D func(target GLenum; level GLint; xoffset GLint; yoffset GLint; x GLint; y GLint; width GLsizei; height GLsizei) extern_binding_dll("opengl32.dll");

def glCullFace func(mode GLenum) extern_binding_dll("opengl32.dll");

def glDeleteLists func(list GLuint; range GLsizei) extern_binding_dll("opengl32.dll");

def glDeleteTextures func(n GLsizei; textures GLuint ref) extern_binding_dll("opengl32.dll");

def glDepthFunc func(func GLenum) extern_binding_dll("opengl32.dll");

def glDepthMask func(flag GLboolean) extern_binding_dll("opengl32.dll");

def glDepthRange func(zNear GLclampd; zFar GLclampd) extern_binding_dll("opengl32.dll");

def glDisable func(cap GLenum) extern_binding_dll("opengl32.dll");

def glDisableClientState func(array GLenum) extern_binding_dll("opengl32.dll");

def glDrawArrays func(mode GLenum; first GLint; count GLsizei) extern_binding_dll("opengl32.dll");

def glDrawBuffer func(mode GLenum) extern_binding_dll("opengl32.dll");

def glDrawElements func(mode GLenum; count GLsizei; type GLenum; indices GLvoid ref) extern_binding_dll("opengl32.dll");

def glDrawPixels func(width GLsizei; height GLsizei; format GLenum; type GLenum; pixels GLvoid ref) extern_binding_dll("opengl32.dll");

def glEdgeFlag func(flag GLboolean) extern_binding_dll("opengl32.dll");

def glEdgeFlagPointer func(stride GLsizei; pointer GLvoid ref) extern_binding_dll("opengl32.dll");

def glEdgeFlagv func(flag GLboolean ref) extern_binding_dll("opengl32.dll");

def glEnable func(cap GLenum) extern_binding_dll("opengl32.dll");

def glEnableClientState func(array GLenum) extern_binding_dll("opengl32.dll");

def glEnd func( ) extern_binding_dll("opengl32.dll");

def glEndList func( ) extern_binding_dll("opengl32.dll");

def glEvalCoord1d func(u GLdouble) extern_binding_dll("opengl32.dll");

def glEvalCoord1dv func(u GLdouble ref) extern_binding_dll("opengl32.dll");

def glEvalCoord1f func(u GLfloat) extern_binding_dll("opengl32.dll");

def glEvalCoord1fv func(u GLfloat ref) extern_binding_dll("opengl32.dll");

def glEvalCoord2d func(u GLdouble; v GLdouble) extern_binding_dll("opengl32.dll");

def glEvalCoord2dv func(u GLdouble ref) extern_binding_dll("opengl32.dll");

def glEvalCoord2f func(u GLfloat; v GLfloat) extern_binding_dll("opengl32.dll");

def glEvalCoord2fv func(u GLfloat ref) extern_binding_dll("opengl32.dll");

def glEvalMesh1 func(mode GLenum; i1 GLint; i2 GLint) extern_binding_dll("opengl32.dll");

def glEvalMesh2 func(mode GLenum; i1 GLint; i2 GLint; j1 GLint; j2 GLint) extern_binding_dll("opengl32.dll");

def glEvalPoint1 func(i GLint) extern_binding_dll("opengl32.dll");

def glEvalPoint2 func(i GLint; j GLint) extern_binding_dll("opengl32.dll");

def glFeedbackBuffer func(size GLsizei; type GLenum; buffer GLfloat ref) extern_binding_dll("opengl32.dll");

def glFinish func( ) extern_binding_dll("opengl32.dll");

def glFlush func( ) extern_binding_dll("opengl32.dll");

def glFogf func(pname GLenum; param GLfloat) extern_binding_dll("opengl32.dll");

def glFogfv func(pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glFogi func(pname GLenum; param GLint) extern_binding_dll("opengl32.dll");

def glFogiv func(pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glFrontFace func(mode GLenum) extern_binding_dll("opengl32.dll");

def glFrustum func(left GLdouble; right GLdouble; bottom GLdouble; top GLdouble; zNear GLdouble; zFar GLdouble) extern_binding_dll("opengl32.dll");

def glGenLists func(range GLsizei) (result GLuint) extern_binding_dll("opengl32.dll");

def glGenTextures func(n GLsizei; textures GLuint ref) extern_binding_dll("opengl32.dll");

def glGetBooleanv func(pname GLenum; params GLboolean ref) extern_binding_dll("opengl32.dll");

def glGetClipPlane func(plane GLenum; equation GLdouble ref) extern_binding_dll("opengl32.dll");

def glGetDoublev func(pname GLenum; params GLdouble ref) extern_binding_dll("opengl32.dll");

def glGetError func( ) (result GLenum) extern_binding_dll("opengl32.dll");

def glGetFloatv func(pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glGetIntegerv func(pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glGetLightfv func(light GLenum; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glGetLightiv func(light GLenum; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glGetMapdv func(target GLenum; query GLenum; v GLdouble ref) extern_binding_dll("opengl32.dll");

def glGetMapfv func(target GLenum; query GLenum; v GLfloat ref) extern_binding_dll("opengl32.dll");

def glGetMapiv func(target GLenum; query GLenum; v GLint ref) extern_binding_dll("opengl32.dll");

def glGetMaterialfv func(face GLenum; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glGetMaterialiv func(face GLenum; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glGetPixelMapfv func(map GLenum; values GLfloat ref) extern_binding_dll("opengl32.dll");

def glGetPixelMapuiv func(map GLenum; values GLuint ref) extern_binding_dll("opengl32.dll");

def glGetPixelMapusv func(map GLenum; values GLushort ref) extern_binding_dll("opengl32.dll");

def glGetPointerv func(pname GLenum; params GLvoid ref ref) extern_binding_dll("opengl32.dll");

def glGetPolygonStipple func(mask GLubyte ref) extern_binding_dll("opengl32.dll");

def glGetString func(name GLenum) (result GLubyte ref) extern_binding_dll("opengl32.dll");

def glGetTexEnvfv func(target GLenum; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glGetTexEnviv func(target GLenum; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glGetTexGendv func(coord GLenum; pname GLenum; params GLdouble ref) extern_binding_dll("opengl32.dll");

def glGetTexGenfv func(coord GLenum; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glGetTexGeniv func(coord GLenum; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glGetTexImage func(target GLenum; level GLint; format GLenum; type GLenum; pixels GLvoid ref) extern_binding_dll("opengl32.dll");

def glGetTexLevelParameterfv func(target GLenum; level GLint; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glGetTexLevelParameteriv func(target GLenum; level GLint; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glGetTexParameterfv func(target GLenum; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glGetTexParameteriv func(target GLenum; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glHint func(target GLenum; mode GLenum) extern_binding_dll("opengl32.dll");

def glIndexMask func(mask GLuint) extern_binding_dll("opengl32.dll");

def glIndexPointer func(type GLenum; stride GLsizei; pointer GLvoid ref) extern_binding_dll("opengl32.dll");

def glIndexd func(c GLdouble) extern_binding_dll("opengl32.dll");

def glIndexdv func(c GLdouble ref) extern_binding_dll("opengl32.dll");

def glIndexf func(c GLfloat) extern_binding_dll("opengl32.dll");

def glIndexfv func(c GLfloat ref) extern_binding_dll("opengl32.dll");

def glIndexi func(c GLint) extern_binding_dll("opengl32.dll");

def glIndexiv func(c GLint ref) extern_binding_dll("opengl32.dll");

def glIndexs func(c GLshort) extern_binding_dll("opengl32.dll");

def glIndexsv func(c GLshort ref) extern_binding_dll("opengl32.dll");

def glIndexub func(c GLubyte) extern_binding_dll("opengl32.dll");

def glIndexubv func(c GLubyte ref) extern_binding_dll("opengl32.dll");

def glInitNames func( ) extern_binding_dll("opengl32.dll");

def glInterleavedArrays func(format GLenum; stride GLsizei; pointer GLvoid ref) extern_binding_dll("opengl32.dll");

def glIsEnabled func(cap GLenum) (result GLboolean) extern_binding_dll("opengl32.dll");

def glIsList func(list GLuint) (result GLboolean) extern_binding_dll("opengl32.dll");

def glIsTexture func(texture GLuint) (result GLboolean) extern_binding_dll("opengl32.dll");

def glLightModelf func(pname GLenum; param GLfloat) extern_binding_dll("opengl32.dll");

def glLightModelfv func(pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glLightModeli func(pname GLenum; param GLint) extern_binding_dll("opengl32.dll");

def glLightModeliv func(pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glLightf func(light GLenum; pname GLenum; param GLfloat) extern_binding_dll("opengl32.dll");

def glLightfv func(light GLenum; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glLighti func(light GLenum; pname GLenum; param GLint) extern_binding_dll("opengl32.dll");

def glLightiv func(light GLenum; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glLineStipple func(factor GLint; pattern GLushort) extern_binding_dll("opengl32.dll");

def glLineWidth func(width GLfloat) extern_binding_dll("opengl32.dll");

def glListBase func(base GLuint) extern_binding_dll("opengl32.dll");

def glLoadIdentity func( ) extern_binding_dll("opengl32.dll");

def glLoadMatrixd func(m GLdouble ref) extern_binding_dll("opengl32.dll");

def glLoadMatrixf func(m GLfloat ref) extern_binding_dll("opengl32.dll");

def glLoadName func(name GLuint) extern_binding_dll("opengl32.dll");

def glLogicOp func(opcode GLenum) extern_binding_dll("opengl32.dll");

def glMap1d func(target GLenum; u1 GLdouble; u2 GLdouble; stride GLint; order GLint; points GLdouble ref) extern_binding_dll("opengl32.dll");

def glMap1f func(target GLenum; u1 GLfloat; u2 GLfloat; stride GLint; order GLint; points GLfloat ref) extern_binding_dll("opengl32.dll");

def glMap2d func(target GLenum; u1 GLdouble; u2 GLdouble; ustride GLint; uorder GLint; v1 GLdouble; v2 GLdouble; vstride GLint; vorder GLint; points GLdouble ref) extern_binding_dll("opengl32.dll");

def glMap2f func(target GLenum; u1 GLfloat; u2 GLfloat; ustride GLint; uorder GLint; v1 GLfloat; v2 GLfloat; vstride GLint; vorder GLint; points GLfloat ref) extern_binding_dll("opengl32.dll");

def glMapGrid1d func(un GLint; u1 GLdouble; u2 GLdouble) extern_binding_dll("opengl32.dll");

def glMapGrid1f func(un GLint; u1 GLfloat; u2 GLfloat) extern_binding_dll("opengl32.dll");

def glMapGrid2d func(un GLint; u1 GLdouble; u2 GLdouble; vn GLint; v1 GLdouble; v2 GLdouble) extern_binding_dll("opengl32.dll");

def glMapGrid2f func(un GLint; u1 GLfloat; u2 GLfloat; vn GLint; v1 GLfloat; v2 GLfloat) extern_binding_dll("opengl32.dll");

def glMaterialf func(face GLenum; pname GLenum; param GLfloat) extern_binding_dll("opengl32.dll");

def glMaterialfv func(face GLenum; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glMateriali func(face GLenum; pname GLenum; param GLint) extern_binding_dll("opengl32.dll");

def glMaterialiv func(face GLenum; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glMatrixMode func(mode GLenum) extern_binding_dll("opengl32.dll");

def glMultMatrixd func(m GLdouble ref) extern_binding_dll("opengl32.dll");

def glMultMatrixf func(m GLfloat ref) extern_binding_dll("opengl32.dll");

def glNewList func(list GLuint; mode GLenum) extern_binding_dll("opengl32.dll");

def glNormal3b func(nx GLbyte; ny GLbyte; nz GLbyte) extern_binding_dll("opengl32.dll");

def glNormal3bv func(v GLbyte ref) extern_binding_dll("opengl32.dll");

def glNormal3d func(nx GLdouble; ny GLdouble; nz GLdouble) extern_binding_dll("opengl32.dll");

def glNormal3dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glNormal3f func(nx GLfloat; ny GLfloat; nz GLfloat) extern_binding_dll("opengl32.dll");

def glNormal3fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glNormal3i func(nx GLint; ny GLint; nz GLint) extern_binding_dll("opengl32.dll");

def glNormal3iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glNormal3s func(nx GLshort; ny GLshort; nz GLshort) extern_binding_dll("opengl32.dll");

def glNormal3sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glNormalPointer func(type GLenum; stride GLsizei; pointer GLvoid ref) extern_binding_dll("opengl32.dll");

def glOrtho func(left GLdouble; right GLdouble; bottom GLdouble; top GLdouble; zNear GLdouble; zFar GLdouble) extern_binding_dll("opengl32.dll");

def glPassThrough func(token GLfloat) extern_binding_dll("opengl32.dll");

def glPixelMapfv func(map GLenum; mapsize GLsizei; values GLfloat ref) extern_binding_dll("opengl32.dll");

def glPixelMapuiv func(map GLenum; mapsize GLsizei; values GLuint ref) extern_binding_dll("opengl32.dll");

def glPixelMapusv func(map GLenum; mapsize GLsizei; values GLushort ref) extern_binding_dll("opengl32.dll");

def glPixelStoref func(pname GLenum; param GLfloat) extern_binding_dll("opengl32.dll");

def glPixelStorei func(pname GLenum; param GLint) extern_binding_dll("opengl32.dll");

def glPixelTransferf func(pname GLenum; param GLfloat) extern_binding_dll("opengl32.dll");

def glPixelTransferi func(pname GLenum; param GLint) extern_binding_dll("opengl32.dll");

def glPixelZoom func(xfactor GLfloat; yfactor GLfloat) extern_binding_dll("opengl32.dll");

def glPointSize func(size GLfloat) extern_binding_dll("opengl32.dll");

def glPolygonMode func(face GLenum; mode GLenum) extern_binding_dll("opengl32.dll");

def glPolygonOffset func(factor GLfloat; units GLfloat) extern_binding_dll("opengl32.dll");

def glPolygonStipple func(mask GLubyte ref) extern_binding_dll("opengl32.dll");

def glPopAttrib func( ) extern_binding_dll("opengl32.dll");

def glPopClientAttrib func( ) extern_binding_dll("opengl32.dll");

def glPopMatrix func( ) extern_binding_dll("opengl32.dll");

def glPopName func( ) extern_binding_dll("opengl32.dll");

def glPrioritizeTextures func(n GLsizei; textures GLuint ref; priorities GLclampf ref) extern_binding_dll("opengl32.dll");

def glPushAttrib func(mask GLbitfield) extern_binding_dll("opengl32.dll");

def glPushClientAttrib func(mask GLbitfield) extern_binding_dll("opengl32.dll");

def glPushMatrix func( ) extern_binding_dll("opengl32.dll");

def glPushName func(name GLuint) extern_binding_dll("opengl32.dll");

def glRasterPos2d func(x GLdouble; y GLdouble) extern_binding_dll("opengl32.dll");

def glRasterPos2dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glRasterPos2f func(x GLfloat; y GLfloat) extern_binding_dll("opengl32.dll");

def glRasterPos2fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glRasterPos2i func(x GLint; y GLint) extern_binding_dll("opengl32.dll");

def glRasterPos2iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glRasterPos2s func(x GLshort; y GLshort) extern_binding_dll("opengl32.dll");

def glRasterPos2sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glRasterPos3d func(x GLdouble; y GLdouble; z GLdouble) extern_binding_dll("opengl32.dll");

def glRasterPos3dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glRasterPos3f func(x GLfloat; y GLfloat; z GLfloat) extern_binding_dll("opengl32.dll");

def glRasterPos3fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glRasterPos3i func(x GLint; y GLint; z GLint) extern_binding_dll("opengl32.dll");

def glRasterPos3iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glRasterPos3s func(x GLshort; y GLshort; z GLshort) extern_binding_dll("opengl32.dll");

def glRasterPos3sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glRasterPos4d func(x GLdouble; y GLdouble; z GLdouble; w GLdouble) extern_binding_dll("opengl32.dll");

def glRasterPos4dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glRasterPos4f func(x GLfloat; y GLfloat; z GLfloat; w GLfloat) extern_binding_dll("opengl32.dll");

def glRasterPos4fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glRasterPos4i func(x GLint; y GLint; z GLint; w GLint) extern_binding_dll("opengl32.dll");

def glRasterPos4iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glRasterPos4s func(x GLshort; y GLshort; z GLshort; w GLshort) extern_binding_dll("opengl32.dll");

def glRasterPos4sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glReadBuffer func(mode GLenum) extern_binding_dll("opengl32.dll");

def glReadPixels func(x GLint; y GLint; width GLsizei; height GLsizei; format GLenum; type GLenum; pixels GLvoid ref) extern_binding_dll("opengl32.dll");

def glRectd func(x1 GLdouble; y1 GLdouble; x2 GLdouble; y2 GLdouble) extern_binding_dll("opengl32.dll");

def glRectdv func(v1 GLdouble ref; v2 GLdouble ref) extern_binding_dll("opengl32.dll");

def glRectf func(x1 GLfloat; y1 GLfloat; x2 GLfloat; y2 GLfloat) extern_binding_dll("opengl32.dll");

def glRectfv func(v1 GLfloat ref; v2 GLfloat ref) extern_binding_dll("opengl32.dll");

def glRecti func(x1 GLint; y1 GLint; x2 GLint; y2 GLint) extern_binding_dll("opengl32.dll");

def glRectiv func(v1 GLint ref; v2 GLint ref) extern_binding_dll("opengl32.dll");

def glRects func(x1 GLshort; y1 GLshort; x2 GLshort; y2 GLshort) extern_binding_dll("opengl32.dll");

def glRectsv func(v1 GLshort ref; v2 GLshort ref) extern_binding_dll("opengl32.dll");

def glRenderMode func(mode GLenum) (result GLint) extern_binding_dll("opengl32.dll");

def glRotated func(angle GLdouble; x GLdouble; y GLdouble; z GLdouble) extern_binding_dll("opengl32.dll");

def glRotatef func(angle GLfloat; x GLfloat; y GLfloat; z GLfloat) extern_binding_dll("opengl32.dll");

def glScaled func(x GLdouble; y GLdouble; z GLdouble) extern_binding_dll("opengl32.dll");

def glScalef func(x GLfloat; y GLfloat; z GLfloat) extern_binding_dll("opengl32.dll");

def glScissor func(x GLint; y GLint; width GLsizei; height GLsizei) extern_binding_dll("opengl32.dll");

def glSelectBuffer func(size GLsizei; buffer GLuint ref) extern_binding_dll("opengl32.dll");

def glShadeModel func(mode GLenum) extern_binding_dll("opengl32.dll");

def glStencilFunc func(func GLenum; ref GLint; mask GLuint) extern_binding_dll("opengl32.dll");

def glStencilMask func(mask GLuint) extern_binding_dll("opengl32.dll");

def glStencilOp func(fail GLenum; zfail GLenum; zpass GLenum) extern_binding_dll("opengl32.dll");

def glTexCoord1d func(s GLdouble) extern_binding_dll("opengl32.dll");

def glTexCoord1dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glTexCoord1f func(s GLfloat) extern_binding_dll("opengl32.dll");

def glTexCoord1fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glTexCoord1i func(s GLint) extern_binding_dll("opengl32.dll");

def glTexCoord1iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glTexCoord1s func(s GLshort) extern_binding_dll("opengl32.dll");

def glTexCoord1sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glTexCoord2d func(s GLdouble; t GLdouble) extern_binding_dll("opengl32.dll");

def glTexCoord2dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glTexCoord2f func(s GLfloat; t GLfloat) extern_binding_dll("opengl32.dll");

def glTexCoord2fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glTexCoord2i func(s GLint; t GLint) extern_binding_dll("opengl32.dll");

def glTexCoord2iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glTexCoord2s func(s GLshort; t GLshort) extern_binding_dll("opengl32.dll");

def glTexCoord2sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glTexCoord3d func(s GLdouble; t GLdouble; r GLdouble) extern_binding_dll("opengl32.dll");

def glTexCoord3dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glTexCoord3f func(s GLfloat; t GLfloat; r GLfloat) extern_binding_dll("opengl32.dll");

def glTexCoord3fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glTexCoord3i func(s GLint; t GLint; r GLint) extern_binding_dll("opengl32.dll");

def glTexCoord3iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glTexCoord3s func(s GLshort; t GLshort; r GLshort) extern_binding_dll("opengl32.dll");

def glTexCoord3sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glTexCoord4d func(s GLdouble; t GLdouble; r GLdouble; q GLdouble) extern_binding_dll("opengl32.dll");

def glTexCoord4dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glTexCoord4f func(s GLfloat; t GLfloat; r GLfloat; q GLfloat) extern_binding_dll("opengl32.dll");

def glTexCoord4fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glTexCoord4i func(s GLint; t GLint; r GLint; q GLint) extern_binding_dll("opengl32.dll");

def glTexCoord4iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glTexCoord4s func(s GLshort; t GLshort; r GLshort; q GLshort) extern_binding_dll("opengl32.dll");

def glTexCoord4sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glTexCoordPointer func(size GLint; type GLenum; stride GLsizei; pointer GLvoid ref) extern_binding_dll("opengl32.dll");

def glTexEnvf func(target GLenum; pname GLenum; param GLfloat) extern_binding_dll("opengl32.dll");

def glTexEnvfv func(target GLenum; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glTexEnvi func(target GLenum; pname GLenum; param GLint) extern_binding_dll("opengl32.dll");

def glTexEnviv func(target GLenum; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glTexGend func(coord GLenum; pname GLenum; param GLdouble) extern_binding_dll("opengl32.dll");

def glTexGendv func(coord GLenum; pname GLenum; params GLdouble ref) extern_binding_dll("opengl32.dll");

def glTexGenf func(coord GLenum; pname GLenum; param GLfloat) extern_binding_dll("opengl32.dll");

def glTexGenfv func(coord GLenum; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glTexGeni func(coord GLenum; pname GLenum; param GLint) extern_binding_dll("opengl32.dll");

def glTexGeniv func(coord GLenum; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glTexImage1D func(target GLenum; level GLint; internalformat GLint; width GLsizei; border GLint; format GLenum; type GLenum; pixels GLvoid ref) extern_binding_dll("opengl32.dll");

def glTexImage2D func(target GLenum; level GLint; internalformat GLint; width GLsizei; height GLsizei; border GLint; format GLenum; type GLenum; pixels GLvoid ref) extern_binding_dll("opengl32.dll");

def glTexParameterf func(target GLenum; pname GLenum; param GLfloat) extern_binding_dll("opengl32.dll");

def glTexParameterfv func(target GLenum; pname GLenum; params GLfloat ref) extern_binding_dll("opengl32.dll");

def glTexParameteri func(target GLenum; pname GLenum; param GLint) extern_binding_dll("opengl32.dll");

def glTexParameteriv func(target GLenum; pname GLenum; params GLint ref) extern_binding_dll("opengl32.dll");

def glTexSubImage1D func(target GLenum; level GLint; xoffset GLint; width GLsizei; format GLenum; type GLenum; pixels GLvoid ref) extern_binding_dll("opengl32.dll");

def glTexSubImage2D func(target GLenum; level GLint; xoffset GLint; yoffset GLint; width GLsizei; height GLsizei; format GLenum; type GLenum; pixels GLvoid ref) extern_binding_dll("opengl32.dll");

def glTranslated func(x GLdouble; y GLdouble; z GLdouble) extern_binding_dll("opengl32.dll");

def glTranslatef func(x GLfloat; y GLfloat; z GLfloat) extern_binding_dll("opengl32.dll");

def glVertex2d func(x GLdouble; y GLdouble) extern_binding_dll("opengl32.dll");

def glVertex2dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glVertex2f func(x GLfloat; y GLfloat) extern_binding_dll("opengl32.dll");

def glVertex2fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glVertex2i func(x GLint; y GLint) extern_binding_dll("opengl32.dll");

def glVertex2iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glVertex2s func(x GLshort; y GLshort) extern_binding_dll("opengl32.dll");

def glVertex2sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glVertex3d func(x GLdouble; y GLdouble; z GLdouble) extern_binding_dll("opengl32.dll");

def glVertex3dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glVertex3f func(x GLfloat; y GLfloat; z GLfloat) extern_binding_dll("opengl32.dll");

def glVertex3fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glVertex3i func(x GLint; y GLint; z GLint) extern_binding_dll("opengl32.dll");

def glVertex3iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glVertex3s func(x GLshort; y GLshort; z GLshort) extern_binding_dll("opengl32.dll");

def glVertex3sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glVertex4d func(x GLdouble; y GLdouble; z GLdouble; w GLdouble) extern_binding_dll("opengl32.dll");

def glVertex4dv func(v GLdouble ref) extern_binding_dll("opengl32.dll");

def glVertex4f func(x GLfloat; y GLfloat; z GLfloat; w GLfloat) extern_binding_dll("opengl32.dll");

def glVertex4fv func(v GLfloat ref) extern_binding_dll("opengl32.dll");

def glVertex4i func(x GLint; y GLint; z GLint; w GLint) extern_binding_dll("opengl32.dll");

def glVertex4iv func(v GLint ref) extern_binding_dll("opengl32.dll");

def glVertex4s func(x GLshort; y GLshort; z GLshort; w GLshort) extern_binding_dll("opengl32.dll");

def glVertex4sv func(v GLshort ref) extern_binding_dll("opengl32.dll");

def glVertexPointer func(size GLint; type GLenum; stride GLsizei; pointer GLvoid ref) extern_binding_dll("opengl32.dll");

def glViewport func(x GLint; y GLint; width GLsizei; height GLsizei) extern_binding_dll("opengl32.dll");
...
def GL_INVALID_INDEX = 0xFFFFFFFFu;
...
def GL_TIMEOUT_IGNORED = 0xFFFFFFFFFFFFFFFFull;
