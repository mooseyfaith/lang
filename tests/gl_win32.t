...
def wglCopyContext func(argument0 HGLRC; argument1 HGLRC; argument2 UINT) (result BOOL) extern_binding("opengl32", true);

def wglCreateContext func(argument0 HDC) (result HGLRC) extern_binding("opengl32", true);

def wglCreateLayerContext func(argument0 HDC; argument1 s32) (result HGLRC) extern_binding("opengl32", true);

def wglDeleteContext func(argument0 HGLRC) (result BOOL) extern_binding("opengl32", true);

def wglGetCurrentContext func() (result HGLRC) extern_binding("opengl32", true);

def wglGetCurrentDC func() (result HDC) extern_binding("opengl32", true);

def wglGetProcAddress func(argument0 LPCSTR) (result PROC) extern_binding("opengl32", true);

def wglMakeCurrent func(argument0 HDC; argument1 HGLRC) (result BOOL) extern_binding("opengl32", true);

def wglShareLists func(argument0 HGLRC; argument1 HGLRC) (result BOOL) extern_binding("opengl32", true);

def wglUseFontBitmapsA func(argument0 HDC; argument1 DWORD; argument2 DWORD; argument3 DWORD) (result BOOL) extern_binding("opengl32", true);

def wglUseFontBitmapsW func(argument0 HDC; argument1 DWORD; argument2 DWORD; argument3 DWORD) (result BOOL) extern_binding("opengl32", true);
def WGL_FONT_LINES = 0;
def WGL_FONT_POLYGONS = 1;

def wglUseFontOutlinesA func(argument0 HDC; argument1 DWORD; argument2 DWORD; argument3 DWORD; argument4 FLOAT; argument5 FLOAT; argument6 s32; argument7 LPGLYPHMETRICSFLOAT) (result BOOL) extern_binding("opengl32", true);

def wglUseFontOutlinesW func(argument0 HDC; argument1 DWORD; argument2 DWORD; argument3 DWORD; argument4 FLOAT; argument5 FLOAT; argument6 s32; argument7 LPGLYPHMETRICSFLOAT) (result BOOL) extern_binding("opengl32", true);
...
def wglDescribeLayerPlane func(argument0 HDC; argument1 s32; argument2 s32; argument3 UINT; argument4 LPLAYERPLANEDESCRIPTOR) (result BOOL) extern_binding("opengl32", true);

def wglSetLayerPaletteEntries func(argument0 HDC; argument1 s32; argument2 s32; argument3 s32; argument4 COLORREF ref) (result s32) extern_binding("opengl32", true);

def wglGetLayerPaletteEntries func(argument0 HDC; argument1 s32; argument2 s32; argument3 s32; argument4 COLORREF ref) (result s32) extern_binding("opengl32", true);

def wglRealizeLayerPalette func(argument0 HDC; argument1 s32; argument2 BOOL) (result BOOL) extern_binding("opengl32", true);

def wglSwapLayerBuffers func(argument0 HDC; argument1 UINT) (result BOOL) extern_binding("opengl32", true);
def WGL_SWAPMULTIPLE_MAX = 16;

def wglSwapMultipleBuffers func(argument0 UINT; argument1 WGLSWAP ref) (result DWORD) extern_binding("opengl32", true);
